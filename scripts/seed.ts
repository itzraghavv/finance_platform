...
const SEED_USER_ID = "user_2rTG13x8Ge6VPigxRNyZxHm093p";
const SEED_CATEGORIES = [
  { id: "category_1", name: "Food", userId: SEED_USER_ID, plaidId: null },
  { id: "category_2", name: "Tavel", userId: SEED_USER_ID, plaidId: null },
  { id: "category_3", name: "Clothing", userId: SEED_USER_ID, plaidId: null },
...
const generateRandomAmount = (category: typeof categories.$inferInsert) => {
  switch (category.name) {
    ...
    case "Bills":
      return Math.random() * 69 + 69;

    case "Miscellaneous":
      return Math.random() * 45 + 12;
